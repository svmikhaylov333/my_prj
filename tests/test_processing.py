...
def test_read_csv_operations_success():
    """Тест чтения CSV-файла"""
    # создание тестовых данных
    test_data = pd.DataFrame([
        {"id": 1, "amount": 100.5, "currency": "USD"},
...
def test_read_csv_operations_not_found():
    """Тест при отсутствии CSV-файла"""
    result = read_csv_operations('non_existent_file.csv')
    assert result == []

def test_read_csv_operations_empty_file():
...
def test_read_csv_operations_only_headers():
...
def test_read_csv_operations_with_nan():
...
@patch('src.file_processing.pd.read_csv')
def test_read_csv_operations_empty_data_error(mock_read_csv):
...
def test_read_excel_operations_success(mock_read_excel):
...
@patch('src.file_processing.pd.read_excel')
def test_read_excel_operations_value_error(mock_read_excel):
    """Тест ошиькбка ValueError"""
...
@patch('src.file_processing.pd.read_excel')
def test_read_excel_operations_general_error(mock_read_excel):
...
@patch('src.file_processing.pd.read_excel')
def test_read_excel_operations_with_nan(mock_read_excel):
